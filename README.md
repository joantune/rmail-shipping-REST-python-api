Added from Swagger's specs found @ https://developer.royalmail.net/node/1859169 and corrected some of the `__init__.py` and others

# rmail-api (Royal Mail's Shipping v2 REST API)
