...
class ManifestServiceCodesRequest(object):
    ...
    def __init__(self, service_codes=None, posting_location=None):  # noqa: E501
        """ManifestServiceCodesRequest - a model defined in Swagger"""  # noqa: E501
    ...
    def service_codes(self):
        """Gets the service_codes of this ManifestServiceCodesRequest.  # noqa: E501

        Service Codes<br />Must be valid system service codes OR customer mapped service codes.  # noqa: E501

        :return: The service_codes of this ManifestServiceCodesRequest.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def service_codes(self, service_codes):
        """Sets the service_codes of this ManifestServiceCodesRequest.

        Service Codes<br />Must be valid system service codes OR customer mapped service codes.  # noqa: E501

        :param service_codes: The service_codes of this ManifestServiceCodesRequest.  # noqa: E501
        :type: list[str]
        """
        if service_codes is None:
            raise ValueError("Invalid value for `service_codes`, must not be `None`")  # noqa: E501

        self._service_codes = service_codes

    @property
    def posting_location(self):
        """Gets the posting_location of this ManifestServiceCodesRequest.  # noqa: E501

        Posting Location.<br />Optional if you only have 1 Posting Location.  # noqa: E501

        :return: The posting_location of this ManifestServiceCodesRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def posting_location(self, posting_location):
        """Sets the posting_location of this ManifestServiceCodesRequest.

        Posting Location.<br />Optional if you only have 1 Posting Location.  # noqa: E501

        :param posting_location: The posting_location of this ManifestServiceCodesRequest.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ManifestServiceCodesRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ManifestServiceCodesRequest):
            return False
