...
class ServiceAvailabilityResponse(object):
    ...
    swagger_types = {
        ...
        'options': 'list[ServiceAvailabilityOption]',
    ...
    def __init__(self, weight_unit_of_measure=None, options=None, http_status_code=None, http_status_description=None, message=None, errors=None):  # noqa: E501
        """ServiceAvailabilityResponse - a model defined in Swagger"""  # noqa: E501
    ...
    def weight_unit_of_measure(self):
        """Gets the weight_unit_of_measure of this ServiceAvailabilityResponse.  # noqa: E501

        Weight Unit of Measure<br />The unit of measure used for the Max Weights.<br />Will be the same as the Weight Unit of Measure received.  # noqa: E501

        :return: The weight_unit_of_measure of this ServiceAvailabilityResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def weight_unit_of_measure(self, weight_unit_of_measure):
        """Sets the weight_unit_of_measure of this ServiceAvailabilityResponse.

        Weight Unit of Measure<br />The unit of measure used for the Max Weights.<br />Will be the same as the Weight Unit of Measure received.  # noqa: E501

        :param weight_unit_of_measure: The weight_unit_of_measure of this ServiceAvailabilityResponse.  # noqa: E501
        :type: str
        """
    ...
    @property
    def options(self):
        """Gets the options of this ServiceAvailabilityResponse.  # noqa: E501

        Service Options<br />The available service options that can be used for the details provided.<br />Populated for successful responses only.  # noqa: E501

        :return: The options of this ServiceAvailabilityResponse.  # noqa: E501
        :rtype: list[ServiceAvailabilityOption]
        """
        return self._options

    @options.setter
    def options(self, options):
        """Sets the options of this ServiceAvailabilityResponse.

        Service Options<br />The available service options that can be used for the details provided.<br />Populated for successful responses only.  # noqa: E501

        :param options: The options of this ServiceAvailabilityResponse.  # noqa: E501
        :type: list[ServiceAvailabilityOption]
        """
    ...
    def http_status_code(self):
        """Gets the http_status_code of this ServiceAvailabilityResponse.  # noqa: E501

        HTTP Status Code  # noqa: E501

        :return: The http_status_code of this ServiceAvailabilityResponse.  # noqa: E501
        :rtype: int
        """
    ...
    def http_status_code(self, http_status_code):
        """Sets the http_status_code of this ServiceAvailabilityResponse.

        HTTP Status Code  # noqa: E501

        :param http_status_code: The http_status_code of this ServiceAvailabilityResponse.  # noqa: E501
        :type: int
        """
    ...
    def http_status_description(self):
        """Gets the http_status_description of this ServiceAvailabilityResponse.  # noqa: E501

        HTTP Status Description  # noqa: E501

        :return: The http_status_description of this ServiceAvailabilityResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def http_status_description(self, http_status_description):
        """Sets the http_status_description of this ServiceAvailabilityResponse.

        HTTP Status Description  # noqa: E501

        :param http_status_description: The http_status_description of this ServiceAvailabilityResponse.  # noqa: E501
        :type: str
        """
    ...
    @property
    def message(self):
        """Gets the message of this ServiceAvailabilityResponse.  # noqa: E501
        ...
        :return: The message of this ServiceAvailabilityResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def message(self, message):
        """Sets the message of this ServiceAvailabilityResponse.

        Message<br />Successful response may include a success message.<br />Failure responses will have general reason as to why. Further details may be contained in the list of errors.  # noqa: E501

        :param message: The message of this ServiceAvailabilityResponse.  # noqa: E501
        :type: str
        """
    ...
    @property
    def errors(self):
        """Gets the errors of this ServiceAvailabilityResponse.  # noqa: E501

        Errors<br />Details about why a request failed.  # noqa: E501

        :return: The errors of this ServiceAvailabilityResponse.  # noqa: E501
    ...
    def errors(self, errors):
        """Sets the errors of this ServiceAvailabilityResponse.

        Errors<br />Details about why a request failed.  # noqa: E501

        :param errors: The errors of this ServiceAvailabilityResponse.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ServiceAvailabilityResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ServiceAvailabilityResponse):
            return False
