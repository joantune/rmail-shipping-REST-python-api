...
class ServiceAvailabilityShipmentPackage(object):
    ...
    def __init__(self, package_occurrence=None, packaging_id=None, weight=None, length=None, width=None, height=None):  # noqa: E501
        """ServiceAvailabilityShipmentPackage - a model defined in Swagger"""  # noqa: E501
    ...
    def package_occurrence(self):
        """Gets the package_occurrence of this ServiceAvailabilityShipmentPackage.  # noqa: E501

        Package Occurrence<br />Unique package number within this shipment.<br />Cannot exceed total number of packages.  # noqa: E501

        :return: The package_occurrence of this ServiceAvailabilityShipmentPackage.  # noqa: E501
        :rtype: int
        """
    ...
    def package_occurrence(self, package_occurrence):
        """Sets the package_occurrence of this ServiceAvailabilityShipmentPackage.

        Package Occurrence<br />Unique package number within this shipment.<br />Cannot exceed total number of packages.  # noqa: E501

        :param package_occurrence: The package_occurrence of this ServiceAvailabilityShipmentPackage.  # noqa: E501
        :type: int
        """
    ...
    def packaging_id(self):
        """Gets the packaging_id of this ServiceAvailabilityShipmentPackage.  # noqa: E501

        Packaging ID<br />If supplied, packaging details will be populated from the stored information.  # noqa: E501

        :return: The packaging_id of this ServiceAvailabilityShipmentPackage.  # noqa: E501
        :rtype: str
        """
    ...
    def packaging_id(self, packaging_id):
        """Sets the packaging_id of this ServiceAvailabilityShipmentPackage.

        Packaging ID<br />If supplied, packaging details will be populated from the stored information.  # noqa: E501

        :param packaging_id: The packaging_id of this ServiceAvailabilityShipmentPackage.  # noqa: E501
        :type: str
        """
    ...
    @property
    def weight(self):
        """Gets the weight of this ServiceAvailabilityShipmentPackage.  # noqa: E501

        Total Package Weight.<br />            <br />This field will be used as the Shipment Weight for single-package services such as RMG.<br />The package weight must be greater than or equal to the sum of all item weights and packaging, if this information is provided.<br />Min weight: 1 gram.  # noqa: E501

        :return: The weight of this ServiceAvailabilityShipmentPackage.  # noqa: E501
        :rtype: float
        """
        return self._weight
    ...
    def weight(self, weight):
        """Sets the weight of this ServiceAvailabilityShipmentPackage.

        Total Package Weight.<br />            <br />This field will be used as the Shipment Weight for single-package services such as RMG.<br />The package weight must be greater than or equal to the sum of all item weights and packaging, if this information is provided.<br />Min weight: 1 gram.  # noqa: E501

        :param weight: The weight of this ServiceAvailabilityShipmentPackage.  # noqa: E501
        :type: float
        """
        if weight is None:
    ...
    @property
    def length(self):
        """Gets the length of this ServiceAvailabilityShipmentPackage.  # noqa: E501
        ...
        :return: The length of this ServiceAvailabilityShipmentPackage.  # noqa: E501
        :rtype: float
        """
        return self._length
    ...
    def length(self, length):
        """Sets the length of this ServiceAvailabilityShipmentPackage.

        Package Length<br />Dimensions are in Centimetres.<br />*Dimensions are optional, however supplying accurate information helps ensure a smooth delivery experience.*  # noqa: E501

        :param length: The length of this ServiceAvailabilityShipmentPackage.  # noqa: E501
        :type: float
        """
    ...
    @property
    def width(self):
        """Gets the width of this ServiceAvailabilityShipmentPackage.  # noqa: E501
        ...
        :return: The width of this ServiceAvailabilityShipmentPackage.  # noqa: E501
        :rtype: float
        """
        return self._width
    ...
    def width(self, width):
        """Sets the width of this ServiceAvailabilityShipmentPackage.

        Package Width<br />Dimensions are in Centimetres.<br />*Dimensions are optional, however supplying accurate information helps ensure a smooth delivery experience.*  # noqa: E501

        :param width: The width of this ServiceAvailabilityShipmentPackage.  # noqa: E501
        :type: float
        """
    ...
    @property
    def height(self):
        """Gets the height of this ServiceAvailabilityShipmentPackage.  # noqa: E501
        ...
        :return: The height of this ServiceAvailabilityShipmentPackage.  # noqa: E501
        :rtype: float
        """
        return self._height
    ...
    def height(self, height):
        """Sets the height of this ServiceAvailabilityShipmentPackage.

        Package Height<br />Dimensions are in Centimetres.<br />*Dimensions are optional, however supplying accurate information helps ensure a smooth delivery experience.*  # noqa: E501

        :param height: The height of this ServiceAvailabilityShipmentPackage.  # noqa: E501
        :type: float
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ServiceAvailabilityShipmentPackage, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ServiceAvailabilityShipmentPackage):
            return False
