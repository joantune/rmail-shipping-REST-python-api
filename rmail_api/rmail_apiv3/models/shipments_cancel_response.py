...
class ShipmentsCancelResponse(object):
    ...
    def __init__(self, shipment_ids=None, http_status_code=None, http_status_description=None, message=None, errors=None):  # noqa: E501
        """ShipmentsCancelResponse - a model defined in Swagger"""  # noqa: E501
    ...
    def shipment_ids(self):
        """Gets the shipment_ids of this ShipmentsCancelResponse.  # noqa: E501

        Shipment Ids<br />Tracking Numbers / Unique Ids of each shipment involved in the request.  # noqa: E501

        :return: The shipment_ids of this ShipmentsCancelResponse.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def shipment_ids(self, shipment_ids):
        """Sets the shipment_ids of this ShipmentsCancelResponse.

        Shipment Ids<br />Tracking Numbers / Unique Ids of each shipment involved in the request.  # noqa: E501

        :param shipment_ids: The shipment_ids of this ShipmentsCancelResponse.  # noqa: E501
        :type: list[str]
        """
    ...
    def http_status_code(self):
        """Gets the http_status_code of this ShipmentsCancelResponse.  # noqa: E501

        HTTP Status Code  # noqa: E501

        :return: The http_status_code of this ShipmentsCancelResponse.  # noqa: E501
        :rtype: int
        """
    ...
    def http_status_code(self, http_status_code):
        """Sets the http_status_code of this ShipmentsCancelResponse.

        HTTP Status Code  # noqa: E501

        :param http_status_code: The http_status_code of this ShipmentsCancelResponse.  # noqa: E501
        :type: int
        """
    ...
    def http_status_description(self):
        """Gets the http_status_description of this ShipmentsCancelResponse.  # noqa: E501

        HTTP Status Description  # noqa: E501

        :return: The http_status_description of this ShipmentsCancelResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def http_status_description(self, http_status_description):
        """Sets the http_status_description of this ShipmentsCancelResponse.

        HTTP Status Description  # noqa: E501

        :param http_status_description: The http_status_description of this ShipmentsCancelResponse.  # noqa: E501
        :type: str
        """
    ...
    @property
    def message(self):
        """Gets the message of this ShipmentsCancelResponse.  # noqa: E501
        ...
        :return: The message of this ShipmentsCancelResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def message(self, message):
        """Sets the message of this ShipmentsCancelResponse.

        Message<br />Successful response may include a success message.<br />Failure responses will have general reason as to why. Further details may be contained in the list of errors.  # noqa: E501

        :param message: The message of this ShipmentsCancelResponse.  # noqa: E501
        :type: str
        """
    ...
    @property
    def errors(self):
        """Gets the errors of this ShipmentsCancelResponse.  # noqa: E501

        Errors<br />Details about why a request failed.  # noqa: E501

        :return: The errors of this ShipmentsCancelResponse.  # noqa: E501
    ...
    def errors(self, errors):
        """Sets the errors of this ShipmentsCancelResponse.

        Errors<br />Details about why a request failed.  # noqa: E501

        :param errors: The errors of this ShipmentsCancelResponse.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ShipmentsCancelResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShipmentsCancelResponse):
            return False
