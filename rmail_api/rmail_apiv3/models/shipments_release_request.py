...
class ShipmentsReleaseRequest(object):
    ...
    def __init__(self, shipment_ids=None):  # noqa: E501
        """ShipmentsReleaseRequest - a model defined in Swagger"""  # noqa: E501
    ...
    def shipment_ids(self):
        """Gets the shipment_ids of this ShipmentsReleaseRequest.  # noqa: E501

        Shipment Ids<br />Tracking Numbers / Unique Ids of each shipment to release from hold.  # noqa: E501

        :return: The shipment_ids of this ShipmentsReleaseRequest.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def shipment_ids(self, shipment_ids):
        """Sets the shipment_ids of this ShipmentsReleaseRequest.

        Shipment Ids<br />Tracking Numbers / Unique Ids of each shipment to release from hold.  # noqa: E501

        :param shipment_ids: The shipment_ids of this ShipmentsReleaseRequest.  # noqa: E501
        :type: list[str]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ShipmentsReleaseRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShipmentsReleaseRequest):
            return False
