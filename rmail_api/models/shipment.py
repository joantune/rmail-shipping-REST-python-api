...
from rmail_api.models.shipment_request_item import ShipmentRequestItem  # noqa: F401,E501
...
class Shipment(object):
    ...
    swagger_types = {
        ...
        'service': 'Service',
        'shipping_date': 'str',
        'items': 'list[ShipmentRequestItem]',
    ...
    def __init__(self, shipment_type=None, service=None, shipping_date=None, items=None, recipient_contact=None, recipient_address=None, sender_reference=None, department_reference=None, customer_reference=None, safe_place=None):  # noqa: E501
    ...
    def shipping_date(self):
        """Gets the shipping_date of this Shipment.  # noqa: E501
        ...
        :return: The shipping_date of this Shipment.  # noqa: E501
        :rtype: str
        """
    ...
    def shipping_date(self, shipping_date):
        """Sets the shipping_date of this Shipment.

        This is the date that the item will be physically sent (in the format YYYY-MM-DD). This may be up to 28 days in the future. Please note that for returns a Shipping date must be provided.  # noqa: E501

        :param shipping_date: The shipping_date of this Shipment.  # noqa: E501
        :type: str
        """
    ...
    def items(self):
        ...
        :rtype: list[ShipmentRequestItem]
        """
        return self._items
    ...
    def recipient_contact(self):
        """Gets the recipient_contact of this Shipment.  # noqa: E501


        :return: The recipient_contact of this Shipment.  # noqa: E501
        :rtype: Contact
        """
    ...
    def recipient_contact(self, recipient_contact):
        """Sets the recipient_contact of this Shipment.


        :param recipient_contact: The recipient_contact of this Shipment.  # noqa: E501
        :type: Contact
        """
    ...
    def recipient_address(self):
        """Gets the recipient_address of this Shipment.  # noqa: E501


        :return: The recipient_address of this Shipment.  # noqa: E501
        :rtype: Address
        """
    ...
    def recipient_address(self, recipient_address):
        """Sets the recipient_address of this Shipment.


        :param recipient_address: The recipient_address of this Shipment.  # noqa: E501
        :type: Address
        """
    ...
    def sender_reference(self):
        """Gets the sender_reference of this Shipment.  # noqa: E501
        ...
        :return: The sender_reference of this Shipment.  # noqa: E501
        :rtype: str
        """
    ...
    def sender_reference(self, sender_reference):
        """Sets the sender_reference of this Shipment.

        This field allows the user to supply their own reference number. Where supported (e.g. Tracked Returns) this number will appear on the label.  # noqa: E501

        :param sender_reference: The sender_reference of this Shipment.  # noqa: E501
        :type: str
        """
    ...
    def department_reference(self):
        """Gets the department_reference of this Shipment.  # noqa: E501

        This is the department reference code that customers can define in OBA.  # noqa: E501

        :return: The department_reference of this Shipment.  # noqa: E501
        :rtype: str
        """
    ...
    def department_reference(self, department_reference):
        """Sets the department_reference of this Shipment.

        This is the department reference code that customers can define in OBA.  # noqa: E501

        :param department_reference: The department_reference of this Shipment.  # noqa: E501
        :type: str
        """
    ...
    def customer_reference(self):
        """Gets the customer_reference of this Shipment.  # noqa: E501
        ...
        :return: The customer_reference of this Shipment.  # noqa: E501
        :rtype: str
        """
    ...
    def customer_reference(self, customer_reference):
        """Sets the customer_reference of this Shipment.

        This field allows customers to supply a reference that applies to multiple shipments and is included to mirror the functionality offered by the Customer Reference field in OBA, whereby a reference can be associated to a group of items. For references that apply to a single shipment, the senderReference field should be used. **Warning** Misuse of this field may result in incorrect billing.  # noqa: E501

        :param customer_reference: The customer_reference of this Shipment.  # noqa: E501
        :type: str
        """
    ...
    @property
    def safe_place(self):
        """Gets the safe_place of this Shipment.  # noqa: E501
        ...
        :return: The safe_place of this Shipment.  # noqa: E501
        :rtype: str
        """
    ...
    def safe_place(self, safe_place):
        """Sets the safe_place of this Shipment.

        For Tracked non-signature service offerings only; this field allows a string that gives details of the recipient’s designated safeplace (e.g. “inside the porch”).  # noqa: E501

        :param safe_place: The safe_place of this Shipment.  # noqa: E501
        :type: str
        """
