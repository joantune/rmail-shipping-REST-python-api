...
class Contact(object):
    ...
    def __init__(self, name=None, complementary_name=None, telephone_number=None, email=None):  # noqa: E501
    ...
    def complementary_name(self):
        """Gets the complementary_name of this Contact.  # noqa: E501

        Business name. If using the Local Collect option, the name format must be&#58; \\'C/O\\' + Location Name + \\'Post Office\\' or \\'Enquiry Office\\' E.g. \"C/O Mount Pleasant Post Office  # noqa: E501

        :return: The complementary_name of this Contact.  # noqa: E501
        :rtype: str
        """
    ...
    def complementary_name(self, complementary_name):
        """Sets the complementary_name of this Contact.

        Business name. If using the Local Collect option, the name format must be&#58; \\'C/O\\' + Location Name + \\'Post Office\\' or \\'Enquiry Office\\' E.g. \"C/O Mount Pleasant Post Office  # noqa: E501

        :param complementary_name: The complementary_name of this Contact.  # noqa: E501
        :type: str
        """
    ...
    def telephone_number(self):
        """Gets the telephone_number of this Contact.  # noqa: E501

        UK mobile phone number. Required if a SMS service enhancement is selected. Conditionally required if using Local Collect service enhancement.  # noqa: E501

        :return: The telephone_number of this Contact.  # noqa: E501
        :rtype: str
        """
    ...
    def telephone_number(self, telephone_number):
        ...
        :param telephone_number: The telephone_number of this Contact.  # noqa: E501
        :type: str
        """
    ...
    def email(self):
        ...
        Email address to be used for notifications. Required if Email enhancement is selected. Conditionally required if using Local Collect service enhancement.  # noqa: E501
