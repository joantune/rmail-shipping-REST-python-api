...
import six
from rmail_api.models.shipment_barcode_item import ShipmentBarcodeItem  # noqa: F401,E501


class ShipmentBarcodeItems(object):
    ...
    def __init__(self):  # noqa: E501
        """ShipmentBarcodeItems - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ShipmentBarcodeItems, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShipmentBarcodeItems):
            return False
