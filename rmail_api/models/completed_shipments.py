...
import six
from rmail_api.models.shipment_with_barcode_and_weight import ShipmentWithBarcodeAndWeight  # noqa: F401,E501


class CompletedShipments(object):
    ...
    def __init__(self):  # noqa: E501
        """CompletedShipments - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CompletedShipments, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CompletedShipments):
            return False
