...
import six
from rmail_api.models.manifest_shipment import ManifestShipment  # noqa: F401,E501


class ManifestShipments(object):
    ...
    def __init__(self):  # noqa: E501
        """ManifestShipments - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ManifestShipments, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ManifestShipments):
            return False
