...
class Address(object):
    ...
    def __init__(self, building_name=None, building_number=None, address_line1=None, address_line2=None, address_line3=None, post_town=None, county=None, post_code=None, country_code=None):  # noqa: E501
    ...
    def post_town(self, post_town):
        ...
        :param post_town: The post_town of this Address.  # noqa: E501
        :type: str
        """
    ...
    def post_code(self):
        ...
        Mandatory for UK addresses. If the Shipment Type is “Return” then this must match the postcode of the registered return address.  # noqa: E501
    ...
    def country_code(self):
        ...
        The relevant country's 2-digit ISO code for the address. Note that this field is case sensitive.   Optional for domestic shipments.    - If supplied, must be UK country code. One of GB,JE,GE or JM.  Mandatory for international shipments.    - DO NOT USE UK country codes. For the list of allowable values, please go to API Shipping V2 page on the Royal Mail API (Developer) Portal and refer to API Shipping Reference Data.  # noqa: E501
